...
const ProductsInfo = (i) => {
  ...
  const cardInfo = [
    ...
    },
    {
      ...
      price: "$1,400",
      description: "PERFECT new pet to add to your underwater collection with your new stimmy",
    ...
    },
    {
      ...
      price: "$7,500",
      description: "Single and need someone to cuddle with? Paige is the perfect cuddler she feels just like a weighted blanket",
    ...
    },
    {
      ...
      name: "Stingy the Ray",
      price: "$3,000",
      description: "Active swimmer? Try beating Stingy at his fast speed of 30 mph. ",
    ...
    },
    {
      ...
      price: "$1,200",
      description: "Loves to go on long car rides in a convertable. Hes loves to take his entire family everywhere so be ready to run in a pack",
